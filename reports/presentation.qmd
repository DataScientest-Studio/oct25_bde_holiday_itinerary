...
::: {.column width="37%"}
![](../images/city_road_to.png){fig-align="center"}
:::
...
![](../images/super_node.png){width=120% fig-align="center"}
:::
...
::: {.column width="48%"}
![](../images/city_coverage.png){width=90% fig-align="center"}

:::

::: {.column width="48%"}
![](../images/poi_coverage.png){width=90% fig-align="center"}
...
::: {.column width="37%"}
![](../images/cities_and_roads.png){width=90% fig-align="right"}
:::
::::
...
::: {.column width="37%"}
![](../images/airflow_runs_detail.png){width=90% fig-align="right"}
:::
::::
